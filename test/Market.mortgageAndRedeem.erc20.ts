...
describe("Market", function () {
  describe("mortgageAndRedeem.erc20", function () {
    it("mortgage revert", async function () {
      ...
      await info.marketKol.connect(user1).buy(params.tid, getTokenAmountWei(1000));
    ...
    it("mortgageAdd revert", async function () {
      ...
      await info.simpleToken.connect(user3).approve(await info.marketKol.getAddress(), BigInt(10) ** BigInt(21))
      await info.simpleToken.transfer(user4.address, BigInt(10) ** BigInt(21))
      await info.simpleToken.connect(user4).approve(await info.marketKol.getAddress(), BigInt(10) ** BigInt(21))
      ...
      await info.marketKol.connect(user3).buy(params.tid, 1000);
      ...
      await info.marketKol.connect(user4).buy(params.tid, 1001);
    ...
    it("redeem revert", async function () {
      ...
      // redeem not enough
      await expect(info.marketKol.connect(user2).redeem(2, 2000)).revertedWith(
        "TAE",
      );

      // redeem 0
      await expect(info.marketKol.connect(user2).redeem(2, 0)).revertedWith("TAE");
    });
    ...
    it("mortgage and mortgageAdd", async function () {
      ...
      await info.simpleToken.connect(user1).approve(await info.marketKol.getAddress(), BigInt(10) ** BigInt(26))
      await info.simpleToken.transfer(user2.address, BigInt(10) ** BigInt(26))
      await info.simpleToken.connect(user2).approve(await info.marketKol.getAddress(), BigInt(10) ** BigInt(26))
      ...
      // user1 mortgage 1000 t1  tokenid=1
      await info.marketKol.connect(user1).mortgage(paramsT1.tid, getTokenAmountWei(1000));
      ...
      await info.marketKol.connect(user1).mortgage(paramsT2.tid, getTokenAmountWei(2000));
      ...
      await info.marketKol.connect(user2).mortgage(paramsT1.tid, getTokenAmountWei(2000));
      ...
      // user2 mortgage 4000 t2  tokenid=4
      await info.marketKol.connect(user2).mortgage(paramsT2.tid, getTokenAmountWei(4000));
      ...
      // user1 mortgageAdd tokenid=1 1000 t1
      await info.marketKol.connect(user1).mortgageAdd(1, getTokenAmountWei(1000));
    ...
    it("redeem", async function () {
      ...
      // user1 redeem  1000 t1 token=1
      let redeemPayToken1 = await info.marketKol
        .connect(user1)
        .redeem.staticCall(1, getTokenAmountWei(1000));
      await info.marketKol.connect(user1).redeem(1, getTokenAmountWei(1000));
      ...
      // user2 redeem  2000 t2 token=8
      let redeemPayToken2 = await info.marketKol
        .connect(user2)
        .redeem.staticCall(8, getTokenAmountWei(2000));
      await info.marketKol.connect(user2).redeem(8, getTokenAmountWei(2000));
      ...
      // user1 redeem  9000 t1 token=1 nft removed
      let redeemPayToken3 = await info.marketKol
        .connect(user1)
        .redeem.staticCall(1, getTokenAmountWei(9000));
      await info.marketKol.connect(user1).redeem(1, getTokenAmountWei(9000));
      ...
      // user2 redeem 43000 t2 token=8 nft removed
      let redeemPayToken4 = await info.marketKol
        .connect(user2)
        .redeem.staticCall(8, getTokenAmountWei(43000));
      await info.marketKol.connect(user2).redeem(8, getTokenAmountWei(43000));
    ...
    it("redeem refund result and mortgage result and mortgageAdd result", async function () {
      ...
      await info.marketKol.connect(user1).mortgage(params.tid, getTokenAmountWei(1000));
      ...
      let mortgageAddGetPayToken = await info.marketKol.connect(user1).mortgageAdd.staticCall(1, getTokenAmountWei(1000));
      await info.marketKol.connect(user1).mortgageAdd(1, getTokenAmountWei(1000));
      ...
      let redeemPayToken = await info.marketKol
        .connect(user1)
        .redeem.staticCall(1, getTokenAmountWei(1000));
      await info.marketKol
        .connect(user1)
