...
import { getAllContractAddress } from "./deploy_utils";

export type AllContractInfoWithERC20 = {
  wallets: any;
...
export async function deployAllContractWithERC20(): Promise<AllContractInfoWithERC20> {
  let wallets;
  ...
  // create kol app
  await foundry.createApp("kol", kolOwnerWallet.address, addressInfo.kol, await kolCurve.getAddress(), await simpleToken.getAddress(), buySellFee);
