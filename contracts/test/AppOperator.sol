...
contract AppOperator {
  ...
  function buy(
    ...
    if (_payTokenIsERC20()) {
      ...
      payTokenAmount = IMarket(market).buyProxy{value: msg.value}(tid, tokenAmount, msg.sender);
    }
  ...
  function redeem(
    ...
    if (_payTokenIsERC20()) {
      ...
      payTokenAmount = IMarket(market).redeemProxy{value: msg.value}(nftTokenId, tokenAmount);
    }
  ...
  function multiply(
    ...
    if (_payTokenIsERC20()) {
      ...
      (nftTokenId, payTokenAmount) = IMarket(market).multiplyProxy{value: msg.value}(tid, multiplyAmount, msg.sender);
    }
  ...
  function multiplyAdd(
    ...
    if (_payTokenIsERC20()) {
      ...
      payTokenAmount = IMarket(market).multiplyAddProxy{value: msg.value}(nftTokenId, multiplyAmount);
    }
  ...
  function split(
    ...
    if (_payTokenIsERC20()) {
      ...
      (payTokenAmount, newNFTTokenId) = IMarket(market).splitProxy{value: msg.value}(nftTokenId, splitAmount);
    }
  ...
  function _transferTo(address to, uint256 payTokenAmount) private {
    if (_payTokenIsERC20()) {
      ...
      _transferEth(to, payTokenAmount);
    }
  }
